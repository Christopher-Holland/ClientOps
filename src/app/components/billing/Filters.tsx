...
import type { Invoice, InvoiceStatus } from "./InvoiceEditor";
...
type DecoratedInvoice = Invoice & { _displayStatus?: InvoiceStatus };

type Props = {
    invoices: DecoratedInvoice[];
